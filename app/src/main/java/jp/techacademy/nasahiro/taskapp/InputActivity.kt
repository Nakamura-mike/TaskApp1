...
import jp.techacademy.nasahiro.taskapp.databinding.ActivityInputBinding
...
//    private val category: String
    ...
    private fun initTask(taskId: Int) {
        ...
        if (findTask == null) {
            ...
            binding.content.categoryEditText.setText(task.category)//20240421
        }
    ...
    private suspend fun addTask() {
        ...
        val category = binding.content.categoryEditText.text.toString() //20240420
        ...
        if (task.id == -1) {
            ...
            task.category = category    //20240420
            task.date = date
            ...
            realm.write {
                findLatest(task)?.apply {
                    ...
                    this.category = category    //20240420
                    this.date = date
                }
            }
        }
